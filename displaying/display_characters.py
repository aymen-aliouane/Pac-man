...
class Animator:
    ...
    def get_pacman_frame(self) -> pygame.Surface:
        """
        get pacman frame will return the new frame of pacman,
        witch will make it look like moving
        """
        # for now the function don't do that yet it just return one image
